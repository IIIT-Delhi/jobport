...
class Job(models.Model):
	...
	jobfile = models.FileField("File ", upload_to='jobfiles', default='', storage=OverwriteStorage(), blank=True, null=True)
...
class Student(models.Model):
	...
	startyear_ug = models.IntegerField("Undergraduate Starting Year", max_length = 4, choices=STARTYEARS, default="2011",blank=True, null=True)
	passingyear_ug = models.IntegerField("Undergraduate Completion Year",max_length = 4, choices=ENDYEARS, default="2015",blank=True, null=True)

	startyear_pg = models.IntegerField("Postgraduate Starting Year", max_length = 4, choices=STARTYEARS, blank=True, null=True)
	passingyear_pg = models.IntegerField("Postgraduate Completion Year",max_length = 4, choices=ENDYEARS,blank=True, null=True)
