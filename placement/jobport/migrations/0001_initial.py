...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'jobport_job', (
            ...
            ('cgpa_min', self.gf('django.db.models.fields.FloatField')(default=0, max_length=2)),
        ...
        db.create_table(u'jobport_student', (
            ...
            ('cgpa_ug', self.gf('django.db.models.fields.FloatField')(default=0, max_length=4)),
            ('university_ug', self.gf('django.db.models.fields.CharField')(default='IIIT Delhi', max_length=100)),
            ('institution_ug', self.gf('django.db.models.fields.CharField')(default='IIIT Delhi', max_length=100)),
            ...
            ('cgpa_pg', self.gf('django.db.models.fields.FloatField')(default=0, max_length=4, null=True, blank=True)),
            ('startyear_ug', self.gf('django.db.models.fields.IntegerField')(default='2011', max_length=4, null=True, blank=True)),
            ('passingyear_ug', self.gf('django.db.models.fields.IntegerField')(default='2015', max_length=4, null=True, blank=True)),
            ('startyear_pg', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('passingyear_pg', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True, blank=True)),
            ('university_pg', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('institution_pg', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
    ...
    models = {
        ...
        u'jobport.job': {
            ...
            'batch': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'jobbatch'", 'null': 'True', 'to': u"orm['jobport.Batch']"}),
            'category': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'cgpa_min': ('django.db.models.fields.FloatField', [], {'default': '0', 'max_length': '2'}),
        ...
        u'jobport.student': {
            ...
            'institution_pg': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'institution_ug': ('django.db.models.fields.CharField', [], {'default': "'IIIT Delhi'", 'max_length': '100'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'passingyear_pg': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            ...
            'startyear_pg': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'startyear_ug': ('django.db.models.fields.IntegerField', [], {'default': "'2011'", 'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'N'", 'max_length': '1'}),
            'university_pg': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
